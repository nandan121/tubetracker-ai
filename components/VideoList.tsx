      ...
      {videos.map((video) => (
        <div key={video.id} className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 inline-block align-top p-2">
          <a
            ...
            className="group flex flex-col bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-red-500/50 transition-all hover:shadow-lg hover:shadow-red-900/20 h-full"
          >
            {/* Thumbnail Container */}
